...
//to open or close modal container
...
function createTicket(ticketColor, data, ticketId) {
    ...
    let ticketCont = document.createElement("div"); //<div></div>
      ...
      //if ticket is being created for the first time, then ticket id would be undefined
...
if (localStorage.getItem(".tickets")) {
    ...
    ticketsArr.forEach(function(ticketObj){
        createTicket(ticketObj.ticketColor, ticketObj.data, ticketObj.ticket);
...
// on clicking removeBtn, make color red and make color yellow in clicking again
...
function handleRemoval(ticket, id){
    ...
    //return index of the ticket inside local storage array
    ...
    function handleColor(ticket, id) {
        ...
        ticketColorStrip.addEventListener("click", function () {
            ...
            //lightpink[ticket-color,lightpink]-->[ticket-color]
    ...
    function handleLock(ticket, id){
        ...
        //Toggle icons and use contenteditable property
